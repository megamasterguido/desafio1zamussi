...
async function pruebas(){
    let prueba = new ProductManager("./Productos.json")
    console.log("1", prueba.init("./Productos.json"))
    console.log("2", prueba.getProducts())
    console.log("3", prueba.getProductById(4))
    console.log("4", prueba.addProduct("Eje Drean Original", "Eje Drean Excellent 166 original", 12000, "https://www.serviceitalia.com.ar/images/uploads/ecommerce/1718.jpg"))
    console.log("5", prueba.getProductById(1))
    console.log("6", prueba.addProduct("Eje Drean Copia", "Eje Drean Excellent 166 copia", "https://www.serviceitalia.com.ar/images/uploads/ecommerce/1718.jpg"))
    console.log("7", prueba.addProduct("Eje Drean Copia", "Eje Drean Excellent 166 original", 4000, "https://www.serviceitalia.com.ar/images/uploads/ecommerce/1718.jpg"))
    console.log("8", prueba.getProducts())
    console.log("9", prueba.updateProduct(2, {title: "Eje Drean Copia"}))
    console.log("10", prueba.updateProduct(3, {title: "Eje Drean Copia", description:"Eje Drean Excellent 166 copia", price: 4000, thumbnail:"https://www.serviceitalia.com.ar/images/uploads/ecommerce/1718.jpg"}))
    console.log("11", prueba.updateProduct(2, {title: "Eje Drean Copia", description:"Eje Drean Excellent 166 copia", price: 4000, thumbnail:"https://www.serviceitalia.com.ar/images/uploads/ecommerce/1718.jpg"}))
    console.log("12", prueba.getProducts())
    console.log("13", prueba.deleteProduct(1))
    console.log("14", prueba.deleteProduct(3))
    console.log("15", prueba.getProducts())
    console.log("16", prueba.addProduct("Eje Drean Original", "Eje Drean Excellent 166 original", 12000, "https://www.serviceitalia.com.ar/images/uploads/ecommerce/1718.jpg"))
    console.log("17", prueba.getProducts())
}
